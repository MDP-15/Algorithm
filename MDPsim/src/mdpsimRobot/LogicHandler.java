...
public class LogicHandler {
	...
	public NodeList adjacent(Node n, ArrayList<ArrayList<Integer>> mapmemory) {
		...
		//F1
		try {
			Node nod = n.F(1).validNode(mapmemory);
		...
		//F2
		try {
			Node nod = n.F(2).validNode(mapmemory);
		...
		//F3
		try {
			Node nod = n.F(3).validNode(mapmemory);
	...
	class Node{
		...
		public Node validNode(ArrayList<ArrayList<Integer>> mapmemory) {
			...
			if (verbose) {
				System.out.print(checkValid(x+1,y-1));
				System.out.print(checkValid(x,y-1));
				System.out.println(checkValid(x-1,y-1));
				System.out.print(checkValid(x+1,y));
				System.out.print(checkValid(x,y));
				System.out.println(checkValid(x-1,y));
				System.out.print(checkValid(x+1,y+1));
				System.out.print(checkValid(x,y+1));
				System.out.println(checkValid(x+1,y-1));
				System.out.println();
